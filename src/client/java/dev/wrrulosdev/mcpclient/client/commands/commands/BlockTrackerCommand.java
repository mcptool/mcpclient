...
public class BlockTrackerCommand implements Command {

    public static String COMMAND_NAME = "blocktracker";

    /**
     * Registers the BlockTracker client command.
     *
    ...
    /**
     * Toggles the BlockTracker cheat.
     *
    ...
    private int executeRoot(CommandContext<FabricClientCommandSource> context) {
        ...
        settings.setBlockTrackerEnabled(!settings.isBlockTrackerEnabled());
        CommandManager.sendStatus(COMMAND_NAME, settings.isBlockTrackerEnabled());
        return 1;
    }
}